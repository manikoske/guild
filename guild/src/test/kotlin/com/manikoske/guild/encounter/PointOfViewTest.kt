...
class PointOfViewTest {
    ...
    fun testAllVantageNodes() {
        ...
        assertThat(minscPointOfView)
            ...
            .isEqualTo(PointOfView(takerId = minsc, allies = listOf(khalid, jaheira), enemies = listOf(tazok, davaeorn)))
        ...
        assertThat(davaeornPointOfView)
            .usingRecursiveComparison()
            .ignoringCollectionOrder()
            .isEqualTo(PointOfView(takerId = davaeorn, allies = listOf(tazok), enemies = listOf(minsc, jaheira, khalid)))
