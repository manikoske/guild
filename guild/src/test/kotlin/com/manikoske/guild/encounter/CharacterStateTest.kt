...
class CharacterStateTest {
    ...
    fun testInitiativeRoll() {
        ...
        every { character.attributeModifier(Attribute.Type.dexterity) } returns attributeModifier
        ...
        val initiativeRoll = characterState.initiativeRoll(Dice.RollMethod.Median)

        // Verify results
        assertThat(initiativeRoll.attributeModifier).isEqualTo(attributeModifier)
        assertThat(initiativeRoll.levelModifier).isEqualTo(levelModifier)
